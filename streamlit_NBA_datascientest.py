        ...
        if bouton_season_type == "mixte":
            ...
            if bouton_home == "mixte":
                ...
                if bouton_adv == "tous":
                    ...
                    if (adversaries[bouton_adv] in df_elargi[df_elargi["player name"] == bouton_joueur_1]["adversary"].unique()) and (adversaries[bouton_adv] in df[df["player name"] == bouton_joueur_2]["adversary"].unique()):
