...
if pages == "Petite initiation à la NBA":
    ...
    st.write("""- **PARTIE 2** : les **Play-in**, introduites lors de l'exercice 2020-2021, par lesquelles doivent passer les franchises **classées de la 7ème place à la 10ème place de chaque conférence** : dans chaque conférence, le 7ème et le 8ème ainsi que le 9ème et le 10ème s'affrontent dans une série **de 7 matchs au plus**.   
    ...
    st.write(
        """
             - **PARTIE 3 :** les **Playoffs**, auxquelles participent les équipes ayant terminées **aux 6 premières places de chaque conférence lors de la saison régulière** ainsi que **les 2 équipes qualifiées à l'issue des Play-in**.  
               Les Playoffs de jouent en **4 tours éliminatoires** dans chaque conférence, dans des séries de 7 matchs comme lors des Play-in : 
