...
fichier = st.sidebar.file_uploader("Cliquez-glissez le fichier excel :")  
...
if pages == "Petite initiation à la NBA":
    ...
    st.dataframe(df_init.head(curseur_data))
    ...
    st.dataframe(filtrage_data(df, bouton_joueur, bouton_variables, bouton_lignes))
