...
if pages == "Petite initiation à la NBA":
    ...
    st.write("""- **PARTIE 2** : les **Play-in**, introduites lors de l'exercice 2020-2021, par lesquelles doivent passer les franchises **classées de la 7ème place à la 10ème place de chaque conférence** : dans chaque conférence, le 7ème et le 8ème ainsi que le 9ème et le 10ème s'affrontent lors d'un seul match décisif, chez l'équipe ayant terminée à la meilleure position lors de la saison régulière** : celle des deux qui remporte ce match reste en lice dans la compétition.   
