...
if pages == "Petite initiation à la NBA":
    ...
    if bouton_groupe == "pivots/ailiers forts":
        ...
        st.write("""**Pour des raisons d'interprétation, au vu des résultats obtenus lors du développement de ce modèle et afin de na pas induire en erreur les utilisateurs, 
